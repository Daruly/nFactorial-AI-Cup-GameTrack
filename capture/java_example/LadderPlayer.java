...
public class LadderPlayer {
    ...
    public static void main( String[] arg ) {
        ...
        ArrayList<java_example.Eight.Puck> plist = new ArrayList<java_example.Eight.Puck>();
        ArrayList<java_example.Eight.Bumper> blist = new ArrayList<java_example.Eight.Bumper>();
        ArrayList<java_example.Eight.Sled> slist = new ArrayList<java_example.Eight.Sled>();
        ...
        while ( tnum >= 0 ) {
            ...
            plist.clear();
            for ( int i = 0; i < n; i++ ) {
                java_example.Eight.Puck p = new java_example.Eight.Puck();
            ...
            blist.clear();
            for ( int i = 0; i < n; i++ ) {
                java_example.Eight.Bumper b = new java_example.Eight.Bumper();
                double x = in.nextDouble();
                double y = in.nextDouble();
            ...
            for ( int i = 0; i < n; i++ ) {
                ...
                java_example.Eight.Sled s = new java_example.Eight.Sled();
                double x = in.nextDouble();
                double y = in.nextDouble();
...
//      LadderPlayer.w_plist(plist);
            ...
            for ( int i = 0; i < 2; i++ ) {
                ...
                if(i == 0){
                    double ansx = xx, ansy = yy;
                    if(prevx - xx > 0 && prevy - yy > 0 && prevx != -1 && prevy != -1){
                        ansx += 5;
                        ansy += 5;
                    }
                    else if(prevx - xx < 0 && prevy - yy < 0 && prevx != -1 && prevy != -1){
                        ansx -= 5;
                        ansy -= 5;
                    }
                    else if(prevx - xx < 0 && prevy - yy > 0 && prevx != -1 && prevy != -1){
...
//                                        Math.abs( plist.get( j ).pos.getY() - 400 ) < 340 &&
                                    ...
                                    moveCount <= 400)
                                target[ i ] = j;
                            else if(plist.get( j ).color == Const.GREY &&
                                    plist.get( j ).pos.distance( tdest ) > 120 &&
                                    Math.abs( plist.get( j ).pos.getX() - 400 ) < 340 &&
                                    Math.abs( plist.get( j ).pos.getY() - 400 ) < 340 &&
                                    ( target[ i ] < 0 ||
...
//java -jar capture.jar -player java java_example.LadderPlayer -player builtin RandomPlayer
//java -jar capture.jar -player java java_example.LadderPlayer -player builtin DoNothingPlayer
